    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?=ucfirst($page)?> bahan</h3>
                <div class="pull-right">
                    <a href="<?=site_url('bahan')?>" class="btn btn-warning btn-flat">
                    ...
                    <div class="col-md-4 col-md-offset-4" >
                        ...
                        <form action="<?=site_url('bahan/process')?>" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="bahan_name" value="<?=$row->name?>" class="form-control" required>
