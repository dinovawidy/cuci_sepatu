    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?=ucfirst($page)?> pemesanan</h3>
                <div class="pull-right">
                    <a href="<?=site_url('pemesanan')?>" class="btn btn-warning btn-flat">
                    ...
                    <div class="col-md-4 col-md-offset-4" >
                        ...
                        <form action="<?=site_url('pemesanan/process')?>" method="post">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id" value="<?=$row->pemesanan_id?>">
                                <input type="text" name="pemesanan_name" value="<?=$row->name?>" class="form-control" required>
